...
mixed:[
  {q:"Which drug is used for chronic pain in neuropathic conditions?", o:["Pregabalin","Paracetamol","Ibuprofen","Amoxicillin"], a:0},
  {q:"What does CPU stand for?", o:["Central Process Unit","Central Processing Unit","Computer Personal Unit","Central Power Unit"], a:1},
  {q:"Which vitamin is produced when skin is exposed to sunlight?", o:["Vitamin A","Vitamin B12","Vitamin C","Vitamin D"], a:3},
  ...
  {q:"What does RAM stand for?", o:["Random Access Memory","Rapid Access Memory","Read Access Memory","Run Access Memory"], a:0},
  ...
  {q:"Which JavaScript method prints output in console?", o:["console.log()","print()","echo()","write()"], a:0},
  {q:"What is the normal pH of blood?", o:["7.4","5","9","2"], a:0},
  {q:"Which medicine is a painkiller?", o:["Ibuprofen","Amoxicillin","Vitamin C","Insulin"], a:0},
  {q:"What does HTML stand for?", o:["Hyper Text Markup Language","High Text Machine Language","Hyper Transfer Markup Language","Home Text Markup Language"], a:0},
  {q:"Which scientist proposed evolution theory?", o:["Newton","Darwin","Einstein","Galileo"], a:1},
  {q:"Which layer of Earth contains molten lava?", o:["Crust","Mantle","Core","Atmosphere"], a:1},

  {q:"Which medicine is used to treat bacterial infections?", o:["Amoxicillin","Paracetamol","Insulin","Aspirin"], a:0},
  {q:"What is the binary of decimal 2?", o:["10","01","11","100"], a:0},
  {q:"Which organ stores bile?", o:["Pancreas","Gallbladder","Kidney","Heart"], a:1},
  {q:"Which is the smallest prime number?", o:["0","1","2","3"], a:2},
  {q:"Which JavaScript function converts string to integer?", o:["parseInt()","toString()","Number()","parseFloat()"], a:0},
  {q:"What is the main function of RBC?", o:["Fight infection","Carry oxygen","Clot blood","Digest food"], a:1},
  {q:"Which country invented paper?", o:["India","China","Japan","Egypt"], a:1},
  {q:"Which storage device has no moving parts?", o:["HDD","SSD","DVD","Tape"], a:1},
  {q:"Which vitamin is important for eyesight?", o:["Vitamin A","Vitamin B","Vitamin C","Vitamin K"], a:0},
  {q:"Which medicine is used for asthma?", o:["Salbutamol","Insulin","Aspirin","Metformin"], a:0},

  {q:"What does LAN stand for?", o:["Local Area Network","Large Area Network","Long Area Node","Light Area Network"], a:0},
  {q:"Which organ pumps blood?", o:["Liver","Kidney","Heart","Lungs"], a:2},
  {q:"Which planet has rings around it?", o:["Mars","Saturn","Venus","Mercury"], a:1},
  {q:"Which JavaScript symbol is used for comments?", o:["//","<!-- -->","##","**"], a:0},
  {q:"What is the smallest unit of life?", o:["Atom","Cell","Tissue","Organ"], a:1},
  {q:"Which medicine is used as antiseptic?", o:["Dettol","Paracetamol","Cetirizine","Insulin"], a:0},
  {q:"Which key is used to refresh a webpage?", o:["F1","F5","F9","F12"], a:1},
  {q:"Which ocean is the largest?", o:["Indian","Atlantic","Pacific","Arctic"], a:2},
  {q:"Which blood component helps in clotting?", o:["RBC","WBC","Platelets","Plasma"], a:2},
  {q:"Which company created Android?", o:["Apple","Google","Microsoft","Samsung"], a:1},

  {q:"Which medicine is used for fungal infection?", o:["Fluconazole","Paracetamol","Metformin","Aspirin"], a:0},
  {q:"What is the speed of light?", o:["3×10^8 m/s","3×10^6 m/s","300 m/s","1500 m/s"], a:0},
  {q:"Which language is mainly used for database queries?", o:["Python","SQL","C++","Java"], a:1},
  {q:"Which human organ produces insulin?", o:["Liver","Pancreas","Heart","Kidney"], a:1},
  {q:"Which country has the highest population?", o:["India","USA","China","Russia"], a:0},
  {q:"Which JavaScript method adds item at end of array?", o:["push()","pop()","shift()","slice()"], a:0},
  {q:"Which gas is released during photosynthesis?", o:["Nitrogen","Carbon dioxide","Oxygen","Hydrogen"], a:2},
  {q:"Which medicine is used to control blood pressure?", o:["Amlodipine","Paracetamol","Cetirizine","Amoxicillin"], a:0},
  {q:"What is the full form of AI?", o:["Artificial Intelligence","Automatic Intelligence","Artificial Integration","Auto Information"], a:0},
  {q:"Which animal is known as the Ship of Desert?", o:["Horse","Camel","Donkey","Elephant"], a:1},

  {q:"Which medicine is used for acidity relief?", o:["Pantoprazole","Ibuprofen","Insulin","Aspirin"], a:0},
  {q:"Which device displays computer output?", o:["Keyboard","Monitor","Mouse","Scanner"], a:1},
  {q:"Which vitamin deficiency causes rickets?", o:["Vitamin A","Vitamin D","Vitamin C","Vitamin B12"], a:1},
  {q:"Which is the largest mammal?", o:["Elephant","Blue Whale","Shark","Giraffe"], a:1},
  {q:"Which JavaScript method removes last array element?", o:["push()","shift()","pop()","slice()"], a:2},
  {q:"Which metal is liquid at room temperature?", o:["Iron","Mercury","Copper","Gold"], a:1},
  {q:"Which medicine is used to reduce inflammation?", o:["Ibuprofen","Amoxicillin","Vitamin C","Insulin"], a:0},
  {q:"Which network covers the largest area?", o:["LAN","MAN","WAN","PAN"], a:2},
  {q:"Which organ helps in digestion of fats?", o:["Liver","Heart","Brain","Lungs"], a:0},
  {q:"Which country is famous for Eiffel Tower?", o:["Italy","Germany","France","Spain"], a:2},

  {q:"Which medicine is used for cough suppression?", o:["Dextromethorphan","Insulin","Aspirin","Metformin"], a:0},
  {q:"Which symbol is used for ID selector in CSS?", o:[".","#","*","@"], a:1},
  {q:"Which blood group is universal recipient?", o:["O-","AB+","A+","B-"], a:1},
  {q:"Which planet is closest to the Sun?", o:["Venus","Earth","Mercury","Mars"], a:2},
  {q:"Which JavaScript method converts object to JSON string?", o:["JSON.parse()","JSON.stringify()","toJSON()","convertJSON()"], a:1},
  {q:"Which medicine is used in thyroid disorders?", o:["Levothyroxine","Paracetamol","Aspirin","Cetirizine"], a:0},
  {q:"Which is the national bird of India?", o:["Parrot","Peacock","Eagle","Sparrow"], a:1},
  {q:"Which part of eye controls amount of light entering?", o:["Retina","Iris","Lens","Cornea"], a:1},
  {q:"Which company created the iPhone?", o:["Samsung","Apple","Google","Nokia"], a:1},
  {q:"Which medicine is commonly used as blood thinner?", o:["Aspirin","Paracetamol","Metformin","Cetirizine"], a:0},
  {q:"Which hormone regulates blood sugar levels?", o:["Insulin","Adrenaline","Thyroxine","Estrogen"], a:0},
  {q:"Which part of computer performs calculations?", o:["ALU","RAM","ROM","GPU"], a:0},
  {q:"What is the scientific name of humans?", o:["Homo sapiens","Pan troglodytes","Felis catus","Canis lupus"], a:0},
  {q:"Which country is known for the Great Wall?", o:["India","China","Japan","Russia"], a:1},
  {q:"Which medicine is used to treat hypertension?", o:["Amlodipine","Ibuprofen","Paracetamol","Cetirizine"], a:0},
  {q:"What does GPU stand for?", o:["Graphics Processing Unit","General Processing Unit","Graphic Power Unit","Global Process Unit"], a:0},
  {q:"Which blood vessel carries oxygenated blood from lungs to heart?", o:["Aorta","Pulmonary vein","Pulmonary artery","Vena cava"], a:1},
  {q:"Which is the largest desert in the world?", o:["Sahara","Gobi","Antarctica","Arabian"], a:2},
  {q:"Which JavaScript method joins array elements into a string?", o:["concat()","join()","push()","slice()"], a:1},
  {q:"Which medicine is used for fungal skin infections?", o:["Clotrimazole","Aspirin","Insulin","Metformin"], a:0},

  {q:"What is the boiling point of water?", o:["50°C","75°C","100°C","120°C"], a:2},
  {q:"Which memory is volatile?", o:["ROM","SSD","RAM","DVD"], a:2},
  {q:"Which organ produces bile juice?", o:["Liver","Kidney","Pancreas","Heart"], a:0},
  {q:"Which country hosted FIFA World Cup 2022?", o:["USA","Brazil","Qatar","France"], a:2},
  {q:"Which medicine is used for motion sickness?", o:["Domperidone","Cetirizine","Ondansetron","Dramamine"], a:3},
  {q:"Which tag is used for paragraph in HTML?", o:["<h1>","<p>","<div>","<a>"], a:1},
  {q:"Which vitamin is essential for calcium absorption?", o:["Vitamin A","Vitamin B","Vitamin C","Vitamin D"], a:3},
  {q:"Which planet is known as Morning Star?", o:["Mars","Venus","Mercury","Saturn"], a:1},
  {q:"Which medicine is used to lower cholesterol?", o:["Atorvastatin","Aspirin","Metformin","Paracetamol"], a:0},
  {q:"Which data structure uses LIFO?", o:["Queue","Stack","Tree","Graph"], a:1},

  {q:"Which gas is most abundant in atmosphere?", o:["Oxygen","Hydrogen","Nitrogen","Carbon dioxide"], a:2},
  {q:"Which organ filters toxins from blood?", o:["Liver","Heart","Lungs","Spleen"], a:0},
  {q:"Which company developed the Linux kernel?", o:["Microsoft","Apple","Linus Torvalds","IBM"], a:2},
  {q:"Which is the hardest natural substance?", o:["Iron","Diamond","Gold","Silver"], a:1},
  {q:"Which medicine is used in bacterial pneumonia?", o:["Azithromycin","Paracetamol","Ibuprofen","Aspirin"], a:0},
  {q:"What is full form of PDF?", o:["Portable Document Format","Public Data File","Printable Document Form","Personal Data Format"], a:0},
  {q:"Which blood group has no antibodies?", o:["A","B","AB","O"], a:2},
  {q:"Which country is famous for pyramids?", o:["Mexico","Egypt","Peru","India"], a:1},
  {q:"Which JavaScript method removes first array element?", o:["shift()","pop()","splice()","slice()"], a:0},
  {q:"Which medicine is used for severe pain relief?", o:["Morphine","Cetirizine","Pantoprazole","Metformin"], a:0},

  {q:"Which layer protects Earth from UV rays?", o:["Troposphere","Mesosphere","Ozone layer","Ionosphere"], a:2},
  {q:"Which device stores electricity?", o:["Battery","Resistor","Switch","Fuse"], a:0},
  {q:"Which organ is responsible for hearing?", o:["Eye","Nose","Ear","Tongue"], a:2},
  {q:"Which country has the Statue of Liberty?", o:["Canada","USA","France","UK"], a:1},
  {q:"Which medicine is used to treat malaria?", o:["Chloroquine","Aspirin","Insulin","Paracetamol"], a:0},
  {q:"What is the shortcut for copy in Windows?", o:["Ctrl+X","Ctrl+C","Ctrl+V","Ctrl+Z"], a:1},
  {q:"Which cell organelle contains genetic material?", o:["Nucleus","Mitochondria","Golgi body","Ribosome"], a:0},
  {q:"Which planet is the largest?", o:["Earth","Saturn","Jupiter","Neptune"], a:2},
  {q:"Which JavaScript keyword declares constant variable?", o:["let","const","var","static"], a:1},
  {q:"Which medicine is used for nausea and vomiting?", o:["Ondansetron","Ibuprofen","Aspirin","Cetirizine"], a:0},

  {q:"What is the SI unit of electric current?", o:["Volt","Watt","Ampere","Ohm"], a:2},
  {q:"Which computer device is used to scan documents?", o:["Printer","Scanner","Monitor","Speaker"], a:1},
  {q:"Which blood cells carry oxygen?", o:["WBC","Platelets","RBC","Plasma"], a:2},
  {q:"Which country is called the Land of Kangaroos?", o:["Australia","South Africa","Canada","Brazil"], a:0},
  {q:"Which medicine is used to treat anxiety?", o:["Diazepam","Paracetamol","Amoxicillin","Aspirin"], a:0},
  {q:"Which symbol is used for classes in CSS?", o:["#",".","$","@"], a:1},
  {q:"Which planet is called Blue Planet?", o:["Mars","Earth","Venus","Mercury"], a:1},
  {q:"Which organ helps maintain body balance?", o:["Brain","Ear","Kidney","Lungs"], a:1},
  {q:"Which medicine is used to treat epilepsy?", o:["Phenytoin","Ibuprofen","Paracetamol","Cetirizine"], a:0},
  {q:"Which company owns YouTube?", o:["Microsoft","Amazon","Google","Meta"], a:2},

  {q:"Which gas is used in balloons?", o:["Helium","Nitrogen","Oxygen","Carbon dioxide"], a:0},
  {q:"Which computer component processes graphics?", o:["CPU","GPU","RAM","ROM"], a:1},
  {q:"Which vitamin deficiency causes night blindness?", o:["Vitamin A","Vitamin B","Vitamin C","Vitamin E"], a:0},
  {q:"Which country is famous for sushi?", o:["China","Japan","Thailand","Korea"], a:1},
  {q:"Which medicine is used to treat tuberculosis?", o:["Rifampicin","Paracetamol","Cetirizine","Aspirin"], a:0},
  {q:"Which HTML tag inserts image?", o:["<img>","<image>","<pic>","<src>"], a:0},
  {q:"Which part of cell produces energy?", o:["Nucleus","Mitochondria","Cytoplasm","Cell wall"], a:1},
  {q:"Which is the tallest mountain in world?", o:["K2","Everest","Kilimanjaro","Kanchenjunga"], a:1},
  {q:"Which medicine is used for acidity and ulcers?", o:["Rabeprazole","Ibuprofen","Aspirin","Metformin"], a:0},
  {q:"Which protocol sends emails?", o:["HTTP","SMTP","FTP","SSH"], a:1},

  {q:"Which organ controls breathing?", o:["Lungs","Brain","Heart","Kidney"], a:1},
  {q:"Which is the largest bone in human body?", o:["Femur","Tibia","Humerus","Skull"], a:0},
  {q:"Which country invented pizza?", o:["France","Italy","USA","Spain"], a:1},
  {q:"Which JavaScript method checks array length?", o:["count()","size()","length","index()"], a:2},
  {q:"Which medicine is used for allergic asthma?", o:["Montelukast","Aspirin","Paracetamol","Metformin"], a:0},
  {q:"Which planet has maximum moons?", o:["Earth","Mars","Saturn","Venus"], a:2},
  {q:"Which computer language is used for Android apps?", o:["Java","Swift","PHP","Ruby"], a:0},
  {q:"Which organ stores urine?", o:["Kidney","Bladder","Liver","Pancreas"], a:1},
  {q:"Which medicine is used for high fever?", o:["Paracetamol","Insulin","Amoxicillin","Cetirizine"], a:0},
  {q:"Which country is known for maple syrup?", o:["Canada","USA","Germany","Russia"], a:0},

  {q:"Which blood component transports nutrients?", o:["Plasma","Platelets","RBC","WBC"], a:0},
  {q:"Which software is used for spreadsheets?", o:["MS Word","MS Excel","Photoshop","Chrome"], a:1},
  {q:"Which vitamin helps immunity?", o:["Vitamin C","Vitamin K","Vitamin D","Vitamin B"], a:0},
  {q:"Which ocean lies between Africa and Australia?", o:["Atlantic","Indian","Pacific","Arctic"], a:1},
  {q:"Which medicine is used in heart attack emergencies?", o:["Aspirin","Cetirizine","Metformin","Ibuprofen"], a:0},
  {q:"Which tag creates line break in HTML?", o:["<break>","<br>","<lb>","<hr>"], a:1},
  {q:"Which part of brain controls memory?", o:["Cerebrum","Medulla","Cerebellum","Pons"], a:0},
  {q:"Which country is famous for tulips?", o:["Netherlands","India","China","Brazil"], a:0},
  {q:"Which medicine is used to treat constipation?", o:["Lactulose","Paracetamol","Aspirin","Azithromycin"], a:0},
  {q:"Which JavaScript operator means NOT equal value?", o:["!=","==","===","<="], a:0},

  {q:"Which gas is necessary for combustion?", o:["Nitrogen","Hydrogen","Oxygen","Helium"], a:2},
  {q:"Which device connects computer to internet?", o:["Monitor","Modem","Keyboard","Printer"], a:1},
  {q:"Which organ produces digestive enzymes?", o:["Pancreas","Lungs","Heart","Brain"], a:0},
  {q:"Which country has largest rainforest?", o:["India","Brazil","Russia","Australia"], a:1},
  {q:"Which medicine is used for fungal dandruff?", o:["Ketoconazole","Paracetamol","Aspirin","Metformin"], a:0},
  {q:"Which HTML tag creates unordered list?", o:["<ol>","<ul>","<li>","<dl>"], a:1},
  {q:"Which blood cells help immunity?", o:["WBC","RBC","Platelets","Plasma"], a:0},
  {q:"Which planet rotates on its side?", o:["Mars","Uranus","Venus","Mercury"], a:1},
  {q:"Which medicine is used to stop seizures?", o:["Valproate","Cetirizine","Pantoprazole","Ibuprofen"], a:0},
  {q:"Which key deletes character before cursor?", o:["Enter","Delete","Backspace","Shift"], a:2},

  {q:"Which organ absorbs nutrients from food?", o:["Large intestine","Small intestine","Liver","Kidney"], a:1},
  {q:"Which country is known for kangaroo?", o:["Australia","New Zealand","Canada","Mexico"], a:0},
  {q:"Which medicine treats dehydration?", o:["ORS","Aspirin","Paracetamol","Cetirizine"], a:0},
  {q:"Which JavaScript function delays execution?", o:["delay()","timeout()","setTimeout()","wait()"], a:2},
  {q:"Which vitamin is important for blood formation?", o:["Vitamin B12","Vitamin D","Vitamin A","Vitamin E"], a:0},
  {q:"Which is the longest river in world?", o:["Amazon","Nile","Yangtze","Ganga"], a:1},
  {q:"Which medicine is used for migraine?", o:["Sumatriptan","Amoxicillin","Metformin","Cetirizine"], a:0},
  {q:"Which protocol transfers files?", o:["SMTP","FTP","HTTP","POP3"], a:1},
  {q:"Which organ removes carbon dioxide from body?", o:["Heart","Kidney","Lungs","Liver"], a:2},
  {q:"Which country is famous for chocolate?", o:["Switzerland","India","Russia","China"], a:0},

  {q:"Which medicine is used to treat depression?", o:["Fluoxetine","Ibuprofen","Paracetamol","Cetirizine"], a:0},
  {q:"Which JavaScript keyword exits loop?", o:["stop","break","exit","return"], a:1},
  {q:"Which organ controls reflex actions?", o:["Cerebrum","Spinal cord","Heart","Lungs"], a:1},
  {q:"Which country has Taj Mahal?", o:["Pakistan","India","Nepal","Bangladesh"], a:1},
  {q:"Which medicine is used for bacterial throat infection?", o:["Penicillin","Aspirin","Cetirizine","Metformin"], a:0},
  {q:"Which computer memory is read-only?", o:["RAM","ROM","Cache","SSD"], a:1},
  {q:"Which vitamin is antioxidant?", o:["Vitamin E","Vitamin K","Vitamin D","Vitamin B"], a:0},
  {q:"Which planet is hottest in solar system?", o:["Mercury","Venus","Mars","Earth"], a:1},
  {q:"Which medicine is used to treat anemia?", o:["Iron supplements","Paracetamol","Ibuprofen","Cetirizine"], a:0},
  {q:"Which symbol starts single-line comment in JavaScript?", o:["//","<!--","##","**"], a:0}
  ]  
};
